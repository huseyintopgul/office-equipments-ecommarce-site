...
const HeaderMenu = () => {
    ...
    return (
        <div className='border fixed'>
            <div className='firt-menu flex items-center justify-around bg-[#d21937] text-white h-[40px] text-sm'>
                <div>
            ...
            <div className='second-menu h-28 flex border-b-2 justify-center space-x-5 items-center px-5'>
                <div className='logo'>
                    <Link to={'/'}>
                ...
                <div className='dropdown inline-block relative'>
                    ...
                    <ul className='dropdown-content absolute hidden text-gray-700 pt-1'>
                        <li className='dropdown w-[250px] border-2'>
                            ...
                            <ul className='dropdown-content absolute hidden text-gray-700 pl-5 ml-[230px] -mt-10'>
